...
object PlayerDebugCommandBridge {
    ...
    const val ACTION_SHOW_MARKS = "show_marks"
    const val ACTION_SHOW_CHAPTERS = "show_chapters"
    const val ACTION_CHAPTER_SWIPE_NEXT = "chapter.swipe_next"
    const val ACTION_CHAPTER_SWIPE_PREVIOUS = "chapter.swipe_previous"
    const val ACTION_MARK_ADD = "mark.add"
    const val ACTION_MARK_LIST = "mark.list"
    const val ACTION_MARK_SEEK = "mark.seek"
